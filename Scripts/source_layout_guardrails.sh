...
allowed_tracked_docs=(
  ...
  "docs/architecture/file-index/00-overview.md"
  "docs/architecture/file-index/01-app.md"
  "docs/architecture/file-index/02-agentmode-runtime.md"
  "docs/architecture/file-index/03-agentmode-viewmodels.md"
  "docs/architecture/file-index/04-agentmode-views-toolcards.md"
  "docs/architecture/file-index/05-agentmode-views-chrome.md"
  "docs/architecture/file-index/06-features-chat-contextbuilder-prompt-search.md"
  "docs/architecture/file-index/07-features-codemap-workspacefiles-workspaces.md"
  "docs/architecture/file-index/08-features-settings.md"
  "docs/architecture/file-index/09-features-diagnostics.md"
  "docs/architecture/file-index/10-infra-ai-providers.md"
  "docs/architecture/file-index/11-infra-ai-prompts-catalog.md"
  "docs/architecture/file-index/12-infra-mcp-services.md"
  "docs/architecture/file-index/13-infra-mcp-core.md"
  "docs/architecture/file-index/14-infra-workspacecontext-vcs.md"
  "docs/architecture/file-index/15-infra-filesystem-diffing-process.md"
  "docs/architecture/file-index/16-infra-ui-components.md"
  "docs/architecture/file-index/17-infra-ui-text-markdown.md"
  "docs/architecture/file-index/18-infra-syntax-security-utilities.md"
  "docs/architecture/file-index/19-cli-shared-packages-ctargets.md"
  "docs/architecture/file-index/20-tests-part1.md"
  "docs/architecture/file-index/21-tests-part2.md"
  "docs/architecture/file-index/22-docs-build-scripts.md"
  "docs/architecture/file-index/README.md"
  "docs/investigations/active-context-engineering.md"
)
